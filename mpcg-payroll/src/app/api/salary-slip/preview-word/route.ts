...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const pfDeduction = config.showPfDeduction ? 1800 : 0;
    ...
    return new NextResponse(wordHtml, {
      ...
      headers: {
        ...
        'Content-Disposition': 'attachment; filename="Sample_Salary_Slip_Template.doc"',
      },
    });
  } catch (error: any) {
    console.error('Failed to generate preview Word document:', error);
